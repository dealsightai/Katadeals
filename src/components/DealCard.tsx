...
if (reco ===
"BUY") return "bg-green-600 text-white";
if (reco ===
"HOLD") return "bg-yellow-500 text-white";
...
rounded-lg ${scoreColor(deal.score)}`}>
Score: {deal.score ?? "
—
"}/10
</span>
...
<span className="font-medium text-slate-700">CF: </span>
${a.estimatedCashFlow?.toLocaleString() ?? "
—
"}/mo
</div>
<div className="text-slate-500">
